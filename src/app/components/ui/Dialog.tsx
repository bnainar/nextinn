...
>(({ children, title, ...props }, forwardedRef: React.Ref<HTMLDivElement>) => (
  <DialogPrimitive.Portal>
    <DialogPrimitive.Overlay className="bg-black/50 data-[state=open]:animate-overlay_Show fixed inset-0 DialogOverlay">
      ...
      >
        <header className="flex justify-between border-b-[1px] border-slate-300 py-4 px-5">
          ...
          <DialogPrimitive.Title className="grow text-center font-semibold text-lg text-gray-900">
            {title}
